\section{(33) Der Hauptsatz der elementaren Zahlentheorie}
...
\noindent
\begin{flalign*}
  \text{Beispiel 1:} &  & 20^2   = 2^45^2 \qquad       & 1) \quad ab = (2^4)(5^2) = 4^2 \cdot 5^2         & \\
  \text{Beispiel 2:} &  & 210^2  = 2^23^25^27^2 \qquad & 1) \quad ab = (2^23^25^2)(7^2) = 30^2 \cdot 7^2  & \\
